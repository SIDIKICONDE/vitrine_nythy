/**
 * Barre supérieure du Header avec infos secondaires
 */
export function TopBar({ isScrolled }: { isScrolled: boolean }) {
  return (
    <div className={`transition-all duration-300 overflow-hidden ${
      isScrolled ? 'max-h-0 opacity-0' : 'max-h-20 opacity-100 border-b border-border'
    }`}>
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-8 text-xs">
          {/* Info gauche */}
          <div className="hidden md:flex items-center gap-6 text-foreground-muted">
